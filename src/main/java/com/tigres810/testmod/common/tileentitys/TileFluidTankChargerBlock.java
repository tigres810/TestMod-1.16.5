...
public class TileFluidTankChargerBlock extends TileEntity implements ITickableTileEntity {
	...
	public TileFluidTankChargerBlock() {
		super(TileEntityInit.FLUIDTANKCHARGER_BLOCK_TILE.get());
	}
