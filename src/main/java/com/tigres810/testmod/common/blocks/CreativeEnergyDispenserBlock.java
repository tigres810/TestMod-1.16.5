...
public class CreativeEnergyDispenserBlock extends Block implements IPipeConnect {
	...
	public CreativeEnergyDispenserBlock(Properties properties) {
		super(properties);
	}
	...
	public TileEntity createTileEntity(BlockState state, IBlockReader world) {
		return TileEntityInit.CREATIVEENERGYDISPENSER_BLOCK_TILE.get().create();
	}
